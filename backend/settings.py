...
MIDDLEWARE = [
    ...
    "corsheaders.middleware.CorsMiddleware",  # Si vous utilisez django-cors-headers
...
SESSION_COOKIE_SECURE = False  # Utilisez True en production, False en développement
